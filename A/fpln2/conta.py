...
COMMAND LINE OPTIONS
       ...
       -I     Run Python in isolated mode. This also implies -E and -s. In iso‐
              lated  mode  sys.path contains neither the script's directory nor
              the user's site-packages directory. All PYTHON* environment vari‐
              ables  are  ignored, too.  Further restrictions may be imposed to
       ...
       -X option
              ...
              warnings are
                      only emitted when an issue is detected. Effect of the de‐
              veloper mode:
...
ENVIRONMENT VARIABLES
   ...
   Debug-mode variables
       ...
       PYTHONTHREADDEBUG
              ...
              debug info.  The feature is deprecated in Python 3.10 and will be
...
c =  texto.count("python") 
d =  texto.count("Python") 
print( c, d , c+d)

# Outra versão!

textm = texto.lower()
c2 =  textm.count("python") 
print(c2)
